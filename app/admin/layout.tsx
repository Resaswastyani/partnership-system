    ...
    <div className="min-h-screen bg-[#0f172a] flex">
        ...
        <div className="p-4 border-b border-white/10 flex items-center justify-between">
          {sidebarOpen && (
            <Link href="/admin" className="flex items-center gap-2">
              ...
              <div>
                <p className="text-white font-bold text-sm">FBL Admin</p>
                <p className="text-[#00d9ff] text-xs">Dashboard</p>
              </div>
            </Link>
          )}
          <button
      ...
      <div className={`${sidebarOpen ? 'ml-64' : 'ml-20'} flex-1 transition-all duration-300`}>
        ...
        <div className="bg-gradient-to-b from-[#1a2847] to-transparent border-b border-white/10 px-6 py-4 flex justify-between items-center sticky top-0 z-30 backdrop-blur-sm">
          <div>
            <h1 className="text-white font-bold text-xl">FBL Partnership Admin</h1>
